...
final class AuditLogPresenter
{
    ...
    private const MODULE_LABELS = [
        ...
        'operational_asset' => 'Aset Perangkat',
        'profile' => 'Profil',
        'qr_code' => 'QR Code',
        'report' => 'Laporan',
        'system' => 'Sistem',
    ...
    private const EVENT_LABELS = [
        ...
        'operational_asset_activated' => 'Aset perangkat diaktifkan',
        'operational_asset_created' => 'Aset perangkat dibuat',
        'operational_asset_deactivated' => 'Aset perangkat dinonaktifkan',
        'operational_asset_updated' => 'Aset perangkat diperbarui',
