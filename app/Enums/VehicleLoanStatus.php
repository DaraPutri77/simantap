...
enum VehicleLoanStatus: string
{
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::Borrowed => 'Sedang Digunakan',
            self::AwaitingReturnInspection => 'Dikembalikan',
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::AwaitingReturnInspection => 'Kendaraan telah dikembalikan dan menunggu pemeriksaan Administrator.',
